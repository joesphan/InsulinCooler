...
static uint8_t  spp_data_receive_val[4] = {'T', 'e', 'S', 't'};

static uint8_t cntr = 0;

///Full HRS Database Description - Used to add attributes into the database
static esp_gatts_attr_db_t spp_gatt_db[SPP_IDX_NB] =
{
...
void namechangertask(void * arg)
{
    uint8_t * cmd_id;
    for(;;){
        vTaskDelay(1000 / portTICK_PERIOD_MS);
        cntr = cntr + 1;
        ESP_LOGI(GATTS_TABLE_TAG, "counter: %d\n", cntr);
        print_write_buffer();
        spp_gatt_db.
...
static void spp_task_init(void)
{
    ...
    /////////////////////////////////////////////////////////////////////////////////
    xTaskCreate(namechangertask, "namechangertask", 2048, NULL, 11, NULL);
}
    	...
    	case ESP_GATTS_WRITE_EVT: {
            ...
            if(p_data->write.is_prep == false){
                ...
                if(res == SPP_IDX_SPP_COMMAND_VAL){
                    ...
                    //uart_write_bytes(UART_NUM_0, (char *)(&cntr), 1);
#endif
                }else{
                    //TODO:
                }
