...
static struct gatts_profile_inst gl_profile_tab[PROFILE_NUM] = {
    [APP_ID] = {
        .gatts_cb = recv_gatts_event_handler,
...
static void recv_gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gl_profile_tab[APP_ID].service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_TEST_A;
        ...
        adv_config_done |= scan_rsp_config_flag;
        esp_ble_gatts_create_service(gatts_if, &gl_profile_tab[APP_ID].service_id, GATTS_NUM_HANDLE_TEST_A);
        break;
...
////////send temperature and battery data
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[APP_ID].char_uuid.len = ESP_UUID_LEN_16;
        gl_profile_tab[APP_ID].char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST_A;

        esp_ble_gatts_start_service(gl_profile_tab[APP_ID].service_handle);
        a_property = ESP_GATT_CHAR_PROP_BIT_READ | ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_NOTIFY;
        esp_err_t add_char_ret = esp_ble_gatts_add_char(gl_profile_tab[APP_ID].service_handle, &gl_profile_tab[APP_ID].char_uuid,
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        esp_err_t add_descr_ret = esp_ble_gatts_add_char_descr(gl_profile_tab[APP_ID].service_handle, &gl_profile_tab[APP_ID].descr_uuid,
